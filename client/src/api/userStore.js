...
const DEFAULT_USERS = [
  ...
  },
  {
    _id: 'u-dgp-1',
    name: 'DGP Lucknow',
    email: 'dgp@safeedup.gov.in',
    username: 'dgp@safeedup.gov.in',
    phone: '9412000008',
    password: 'DGP@123',
    role: 'DISTRICT_ADMIN',
  ...
  },
  {
    ...
    rankLevel: 'SHO',
    designation: 'Station House Officer — West Zone',
  ...
  },
  {
    ...
    assignedPortal: 'INSPECTION_OFFICER',
    rankLevel: 'SI',
    designation: 'Sub-Inspector — Central Zone',
  ...
  },
  {
    ...
    assignedPortal: 'INSPECTION_OFFICER',
    rankLevel: 'PS',
    designation: 'Police Station Official — North Zone',
  ...
  },
  {
    ...
    assignedPortal: 'INSPECTION_OFFICER',
    rankLevel: 'SI',
    designation: 'Sub-Inspector — East Zone',
  ...
  },
  {
    ...
    assignedPortal: 'INSPECTION_OFFICER',
    rankLevel: 'SHO',
    designation: 'Station House Officer — South Zone',
  ...
  },
  {
    _id: 'u-adcp-1',
    name: 'ADCP Central',
    email: 'adcp@safeedup.gov.in',
    username: 'adcp@safeedup.gov.in',
    phone: '9412000010',
    password: 'ADCP@123',
    role: 'DISTRICT_ADMIN',
    assignedPortal: 'DISTRICT_ADMIN',
  ...
  },
  {
    _id: 'u-acp-1',
    name: 'ACP North',
    email: 'acp@safeedup.gov.in',
    username: 'acp@safeedup.gov.in',
    phone: '9412000011',
    password: 'ACP@123',
    role: 'DISTRICT_ADMIN',
    assignedPortal: 'DISTRICT_ADMIN',
...
function initStore() {
  ...
  // Ensure default users exist in existing store
  let updated = false;
  DEFAULT_USERS.forEach(def => {
    if (!existing.users.some(u => u.email?.toLowerCase() === def.email?.toLowerCase())) {
      existing.users.push(def);
      updated = true;
    }
  });
  if (updated) {
