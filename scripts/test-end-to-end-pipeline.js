...
const Document = require('../server/src/models/Document.model');
const SafeID = require('../server/src/models/SafeID.model');
const documentService = require('../server/src/services/document.service');
const qrService = require('../server/src/services/qr.service');
...
async function runEndToEndTest() {
  ...
  try {
    ...
    if (!institution) {
      ...
      // Reset QR status for clean test
