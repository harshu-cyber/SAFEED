...
const DOCUMENT_TYPES = {
  ...
  FIRE_NOC: 'FIRE_SAFETY',
  BUILDING_PLAN: 'BUILDING_SAFETY',
  AFFILIATION_CERT: 'ELECTRICAL_SAFETY',
  EMERGENCY_PLAN: 'EVACUATION_SAFETY',
  POLICE_NOC: 'FIRE_SAFETY',
  LAND_DOCUMENT: 'BUILDING_SAFETY',
  STAFF_LIST: 'ELECTRICAL_SAFETY',
  INSURANCE: 'EVACUATION_SAFETY',
  OTHER: 'OTHER',
};
